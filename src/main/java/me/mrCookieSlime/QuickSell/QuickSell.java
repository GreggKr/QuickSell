                ...
                if (args.length >= 1) {
                    if (args[0].equalsIgnoreCase("reload")) {
                        ...
                        if (args.length == 4) {
                            if (Shop.getShop(args[1]) != null) {
                                ...
                                if (number) {
                                    ...
                                    local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell edit <ShopName> <Item> <Price>"));
                            } else local.sendTranslation(sender, "messages.unknown-shop", false);
                        } else
                            local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell edit <ShopName> <Item> <Price>"));
                        ...
                        if (args.length == 2) {
                            ...
                            local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell create <ShopName>"));
                        ...
                        if (Shop.getShop(args[1]) == null)
                            ...
                            local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell delete <ShopName>"));
                        ...
                        if (args.length == 3) {
                            ...
                            local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell linknpc <ShopName> <sell/sellall>"));
                        ...
                        if (args.length == 2) {
                            ...
                            local.sendTranslation(sender, "commands.usage", false, new Variable("%usage%", "/quicksell stopboosters <Player>"));
